<div class="fadeIn first">
      ...
      <div id="mensaje" class="error" style="font-weight: bold !important;font-weight: bold !important;font-size: 18px;color: red;" align="center">
...
?>			
	 ...
	 <!-- gestion de Usuarios -->
	 <form class="form-horizontal" id="idForma" method="post" action="../controller/transacciones.php?accion=guardarRetiro">
		<fieldset>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label" for="passID">Saldo a retirar : *</label>  
		  <div class="col-md-5">
            <input id="saldoID" name="retiroID" class="form-control" placeholder="saldo a retirar" type="text" required="">
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-8"> 
			<button class="btn btn-primary" type="submit" value="Retirar"><span class=" glyphicon glyphicon-floppy-saved"> </span> Retirar</button>	
